...
const AnimatedButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, animateOnHover = true, animateOnTap = true, ...props }, ref) => {
    ...
    return (
      <motion.div
        whileHover={animateOnHover ? { scale: 1.03 } : {}}
        whileTap={animateOnTap ? { scale: 0.97 } : {}}
